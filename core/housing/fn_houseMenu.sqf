...
if (_curTarget isKindOf "House" && playerSide isEqualTo west) exitWith {
    ...
    private _vaultHouse = [[["Altis", "Land_Research_house_V1_F"], ["RL_Map", "Land_Medevac_house_V1_F"]]] call TON_fnc_terrainSort;
    private _altisArray = [16019.5,16952.9,0];
    private _tanoaArray = [11074.2,11501.5,0.00137329];
    private _pos = [[["Altis", _altisArray], ["RL_Map", _tanoaArray]]] call TON_fnc_terrainSort;

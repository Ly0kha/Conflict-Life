...
_Header ctrlSetPosition [0.350 * safezoneW + safezoneX, 0.01 * safezoneH + safezoneY, 0.2 * safezoneW, 0.011 * safezoneH];
...
_TextField ctrlSetPosition [0.350 * safezoneW + safezoneX, 0.021 * safezoneH + safezoneY,0.2 * safezoneW, 0.5];
_TextField ctrlCommit 0;
_TextField ctrlSetPosition [0.350 * safezoneW + safezoneX, 0.021 * safezoneH + safezoneY,0.2 * safezoneW, ((ctrlTextHeight _TextField)+ (0.005 * safezoneH))];
...
if (count life_open_notifications > 0) then {
 ...
 _ctrlHeader ctrlSetPosition [0.350 * safezoneW + safezoneX, (_posHeader + _textHigh + 1.5*(0.011 * safezoneH))];
 _ctrlText ctrlSetPosition [0.350 * safezoneW + safezoneX, (_posText + _textHigh + 1.5*(0.011 * safezoneH))];
